...
describe "forecast controller" do
  describe "index" do
    ...
    it "can accept json payload when query params are not passed", :vcr do 
      params = {"location": 'denver, CO'}
      get '/api/v1/forecast', headers: {'Content-type' => 'application/json', "HTTP_ACCEPT" => 'application/json'}, params: params
